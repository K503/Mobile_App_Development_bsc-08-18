...
class DbHelper extends SQLiteOpenHelper{
    ...
    public static final String CREATE_CLASS_TABLE =
            "CREATE TABLE " + CLASS_TABLE_NAME + "( " +
                    ...
                    "UNIQUE (" + COURSE_NAME_KEY + "," + COURSE_CODE_KEY + ")" +
                    ");";
    ...
    long addClass(String courseName, String courseCode){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COURSE_NAME_KEY, courseName);
        values.put(COURSE_CODE_KEY, courseCode);
    ...
    long updateClass( long cid, String courseName, String courseCode){
        SQLiteDatabase database = this.getWritableDatabase();
        ContentValues values = new ContentValues();
        values.put(COURSE_NAME_KEY,courseName);
        values.put(COURSE_CODE_KEY, courseCode);
